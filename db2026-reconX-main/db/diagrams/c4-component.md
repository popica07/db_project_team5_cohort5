# TICKET-ADV004 — C4 Component diagram (Level 3)

> Zoom into ONE container — the **recon-service API** — and show its major
> Spring components grouped by stereotype. Neighbouring containers (UI,
> Postgres, Kafka) appear at the edge as referenced externals, not as
> components.
